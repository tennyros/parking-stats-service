...
class ParkingControllerV2Test {
    ...
    void registerEntry_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/parking/entry")
    ...
    void processExit_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/parking/exit")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void processExit_CarNotFound() throws Exception {
        CarExitRequest request = new CarExitRequest("А123ВС777");
        when(exitService.processExit(any(String.class)))
    ...
    void generateReport_Success() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/parking/report")
